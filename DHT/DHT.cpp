...
void DHT::setup(uint8_t pin, DHT_MODEL_t model)
{
	DHT::pin = pin;
	DHT::model = model;
	/* Make sure we do read the sensor in the next readSensor() */
	DHT::resetTimer();
...
/*
* 	At the expense of 26 bytes of extra PROGMEM,
* 	we save 11 bytes of SRAM by using the following method:
*/
